...
class save_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'Qt', (Question, Question.thrift_spec), None, ), # 1
  )
  ...
  def write(self, oprot):
    ...
    if self.Qt is not None:
      oprot.writeFieldBegin('Qt', TType.STRUCT, 1)
      self.Qt.write(oprot)
      oprot.writeFieldEnd()
